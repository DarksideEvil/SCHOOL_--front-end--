...
function Login(){
    ...
    return(
        <>
            {/* <div className="login_content1 bg-dark pb-5 mt-4">
                <div className="row d-flex justify-content-center">
                    <div className="col-md-4 ">
                        <h2 className="header_txt mt-4 text-white mb-4 text-center">Login</h2>
                        <select 
                            name=""
                        ...
                        <form className="text-center" onSubmit={submit}>
                            ...
                            <input
                                ...
                                required={true}
                            />
                            <button className="log_btn mt-3 px-4 py-2">SEND</button>
                        </form>
                    </div>
                </div>
            </div> */}
